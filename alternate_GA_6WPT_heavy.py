...
antibodyheavy = open("antibodyheavy_6WPT.txt")
antibodyheavy_sequence = antibodyheavy.readline().rstrip("\n")
print(antibodyheavy_sequence)
...
antibodyheavy_array = aa2int(antibodyheavy_sequence)

#%% set antibody array as input
antibody_inputs = antibodyheavy_array
num_weights = 127
...
x = new_population[best_match, :]
mutated_antibody_array = x.astype(int)

print("Best solution: ", mutated_antibody_array)
